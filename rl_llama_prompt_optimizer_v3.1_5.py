...
Examples:
wbgmsst, aerospace-grade precision-engineered <original prompt>, high-tech finish, white background
wbgmsst, aerospace-grade precision-engineered <original prompt>, ultra-high, white background
wbgmsst, defense-grade ultra-precision <original prompt>, ultra-high technical specification, white background
wbgmsst, aerospace-grade <original prompt>, ultra-high, white background
wbgmsst, defense-grade <original prompt>, ultra-high technical specification, white background
etc. 
...
GENERATE YOUR CUSTOM PROMPT:"""
    ...
    def _query_llama(self, system_prompt: str, user_prompt: str, creativity: float) -> str:
        """Query LLaMA with dynamic parameters"""
