...
class TrellisGenerator:
    ...
    def _load_flux_models(self):
        ...
        try:
            ...
            # self.flux_pipeline.load_lora_weights(lora_repo)
            
            # self.flux_pipeline.load_lora_weights("Shakker-Labs/FLUX.1-dev-LoRA-live-3D", weight_name="FLUX-dev-lora-live_3D.safetensors")
            # self.flux_pipeline.fuse_lora(lora_scale=1.1)
            
            # self.flux_pipeline.load_lora_weights("fal/3D-Game-Assets-Kontext-Dev-LoRA", weight_name="MnzfOWwLjl1CL_0qu7F6E_adapter_model_comfy_converted.safetensors")
            self.flux_pipeline.load_lora_weights("patched_realism_LoRA.safetensors")
