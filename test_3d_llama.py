...
def main():
    ...
    input_image_path = os.path.join(LLAMA_PATH, "examples/images/000.png")
    if not os.path.exists(input_image_path):
        raise FileNotFoundError(f"Example image not found at {input_image_path}")
    ...
    try:
        ...
        with torch.no_grad():
            ...
            textured_mesh = texture_model(input_image_path, prepared_mesh)
