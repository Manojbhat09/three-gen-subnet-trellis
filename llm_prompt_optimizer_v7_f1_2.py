...
Your final output must start with `wbgmsst,` and end with `, 3D isometric accurate, white background`. Do not add any explanation, just the optimized prompt.
"""
...
* **OPTIMIZED (Score: 0.9157):** `wbgmsst, a sturdy iron pickaxe suspended over a serene lake with lotus flowers and gentle ripples on the surface, catches the light, surrounded by a soft, ethereal glow, in a refined, weathered state, white background`

* **ORIGINAL:** `triple-barrel baseball bat`
* **OPTIMIZED (Score: 0.88):** `wbgmsst, a sturdy triple-barrel baseball bat suspended over a serene lake with lotus flowers and gentle ripples on the surface, catches the light, surrounded by a soft, ethereal glow, in a refined, weathered state, white background`
