...
if __name__ == "__main__":
    ...
    test_prompts = [
        ...
        "A chair looking like an avocado",
        "modern minimalist coffee table with glass top",
        "vintage steampunk mechanical clock"
    ]
    ...
    result = optimizer.run_optimized_generation(
        ...
        output_prefix="barn_optimized2",
        seed=42
    )
    
    print(f"\nOptimization complete! Check the generated files.")
    print(f"Quality improvements applied:")
    print(f"- Enhanced text preprocessing")
    print(f"- Adaptive guidance scheduling") 
    print(f"- Higher resolution rendering")
    print(f"- Advanced post-processing")
