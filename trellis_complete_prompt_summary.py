#!/usr/bin/env python3
"""
Complete TRELLIS Prompt Summary Analysis
Analyzes winning and losing prompts for each version with detailed statistics.
"""
...
class TrellisCompletePromptAnalyzer:
    def __init__(self):
    ...
    def generate_complete_summary(self):
        ...
        print("=" * 120)
        print("COMPLETE TRELLIS PROMPT SUMMARY - WINNING & LOSING PROMPTS BY VERSION")
        print("=" * 120)
        ...
        print(f"   BASE: {len(base_data)} tasks")
        ...
        print(f"{'Version':<10} {'Total':<8} {'Winning':<8} {'Losing':<8} {'Success%':<10} {'Avg Score':<12} {'Max Score':<12} {'Max Prompt'}")
        print(f"{'-'*10} {'-'*8} {'-'*8} {'-'*8} {'-'*10} {'-'*12} {'-'*12} {'-'*50}")
        ...
        for version_name, data in versions:
            ...
            if analysis:
                ...
                print(f"{version_name:<10} {analysis['total_tasks']:<8} {analysis['winning_count']:<8} {analysis['losing_count']:<8} {analysis['success_rate']:<10.1f} {analysis['average_score']:<12.4f} {analysis['max_score']:<12.4f} {max_prompt}")
        ...
        print(f"\n{'='*120}")
        print(f"COMPLETE SUMMARY ANALYSIS FINISHED")
        print(f"{'='*120}")

def main():
    analyzer = TrellisCompletePromptAnalyzer()
