...
Method 2 (Example-Based / Few-Shot): Provides the LLM with a list of
           original prompts and their corresponding top winning optimized
...
**WINNING OPTIMIZED:** `wbgmsst, Design a sumptuously indulgent cupcake with an outrageously rich and intensely chocolatey icing on top, set against a clean white background, white background`

**ORIGINAL:** `small round blue creature with long nose and pointed ears`
**WINNING OPTIMIZED:** `wbgmsst, large round blue creature with a slender, angular nose and small pointed ears on a white background, surrounded by a soft, ethereal glow, white background`

**ORIGINAL:** `tall glass of layered lemonade`
**WINNING OPTIMIZED:** `wbgmsst, a slender glass of layered lemonade suspended in mid-air over a serene lake with lotus flowers and gentle ripples on the surface, white background`

**ORIGINAL:** `bottle of red wine with cork in it`
**WINNING OPTIMIZED:** `wbgmsst, Describe a richly colored bottle of red wine with cork in it on a crisp white background, focusing on its nuanced color palette and subtle texture variations, emphasizing the interplay between light and shadow., white background`

**ORIGINAL:** `cylindrical glass of bubbly lemonade`
**WINNING OPTIMIZED:** `wbgmsst, with a frosted glass filled to the brim and garnished with a sprig of fresh mint on one side that's perfectly balanced in mid-air against a crisp white background, white background`

**ORIGINAL:** `matte black candle holder two interlocking pieces`
**WINNING OPTIMIZED:** `wbgmsst, refined and premium modern candle holder two piece set, white background`

**ORIGINAL:** `greek kylix cup black-figure technique mythological scenes`
**WINNING OPTIMIZED:** `wbgmsst, greek kylix cup black-figure technique mythological figures with griffins, satyrs, harpies, centaurs, and nymphs, white background`

**ORIGINAL:** `necklace with heart-shaped pendant made of silver and turquoise stones`
**WINNING OPTIMIZED:** `wbgmsst, a breathtakingly beautiful heart-shaped pendant with delicate gold filigree that catches the light, featuring a rich central turquoise stone, set against a soft white background, white background`
